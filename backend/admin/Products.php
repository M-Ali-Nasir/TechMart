...
if (isset($_SESSION['user']) && $_SESSION['user']['role'] == 'admin') {
  ...
  // echo $twig->render('admin/products.twig', ['categories' => $categories, 'subcategories' => $subcategories, 'products' => $products, 'err' => $err]);

  // echo $twig->render('admin/products.twig', ['categories' => $categories, 'subcategories' => $subcategories, 'products' => $products, 'message' => $message]);

  echo $twig->render('admin/products.twig', ['categories' => $categories, 'subcategories' => $subcategories, 'products' => $products, 'message' => $message, 'totalPages' => $totalPages, 'currentPage' => $page]);
} else {
